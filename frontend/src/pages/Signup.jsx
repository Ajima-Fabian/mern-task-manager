  ...
  return (
    <div className='max-w-md w-full mx-auto mt-10 shadow-md py-5 px-7'>
        ...
        <form className='flex flex-col space-y-4 mt-4'>
            ...
            <button className='text-lg p-2 border border-blue-600 rounded-md font-bold text-blue-600 hover:bg-blue-600 hover:text-white transition duration-300 tracking-wider'>Create</button>
        </form>
    </div>
  )
}
