  ...
  return (
    <div className='max-w-md w-full mx-auto mt-10 shadow-md py-5 px-7'>
        ...
        <form className='flex flex-col space-y-4 mt-4'>
            ...
            <button className='text-lg p-2 bg-blue-600 rounded-md font-bold text-white hover:border-blue-600 hover:text-blue-600 hover:border hover:bg-white transition duration-300 tracking-wider'>Login</button>
        </form>
    </div>
  )
}
